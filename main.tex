...
\vfill
{\bf Poďakovanie:} Chcela by som sa poďakovať môjmu školiteľovi Jakubovi za jeho trpezlivosť s mojimi otázkami, ochotu pripomienkovať všetky verzie práce, podporou a nadšenie, ktoré mi dodávalo nádej, že to dopadne všetko dobre :). %Ďalej by som sa chcela poďakovať kamarátovi Damimu, ktorý mi pomohol opraviť vyčerpávajúci zoznam gramatických chýb. A v neposlednom rade by som sa chcela poďakovať mojej rodine, ktorá ma po celý ten čas podporovala.
...
efektívne a zároveň so zachovaním čo najväčšieho množstva kódu 
presunúť do jazyka \JS{} s návrhovým vzorom Redux. 
...
\TODO{}
In thesis, we compare single-page application in Dart language with design pattern Flux to application in \JS{} language with design pattern Redux.
We describe, how could application in Dart language with pattern Flux both effectively and ---- be moved to \JS{} language with pattern Redux.
We explain motivation, why is this ---- in single-page application development.
