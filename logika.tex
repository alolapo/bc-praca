...
V našej aplikácii používame knižnicu \emph{redux-observable}. Táto možnosť je najviac podobná prístupu funkcie \emph{dispatchAsync}, ktorú používame vo Flux-ovej architektúre. \TODO{} (myslím, že najviac sa ku našej funkcii podobá promise :) )
