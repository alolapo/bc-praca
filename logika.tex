...
%\TODO{}: \emph{\uv{Given the same arguments, it should calculate the next state and return it. No surprises. No side effects. No API calls. No mutations. Just a calculation.}}(\TODO{}, aj Date.now() má side effects!)
...
(\TODO{} formulácia - so snahou Flux)

(\TODO{} niečo, čo zatiaľ neviem prečítať) 
...
\TODO{} virtual DOM - knižnica \emph{React}, v Dart-e knižnica \emph{tiles} založená na \emph{React}
