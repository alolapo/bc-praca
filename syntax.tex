...
%dostupnost JS a webovych prehliadacov
...
Promise sa nevyhýba callbackom - vhodne ich zaobaluje, aby sa s nimi spoľahlivo pracovalo.
...
Promises môžeme reťaziť za sebou. To nám umožňuje rozmýšľať aj nad asynchrónnymi operáciami sekvenčne.%TODO dava toto zmysel?

%TODO listing nejakého promisu
...
%Legendy hovoria, že existuje aj niečo podobné ako async-await ale v špecifikácii som to nenašla
%silno to súvisí s Promismi
%https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/await
%await bude údajne v špecifikácii 2017-ky
%await preruší vykonávanie programu a počká, kým sa ukončí promise, ku ktorému patrí
%async označuje funkciu, ktorá je vykonávaná asynchrónne, a môže obsahovať volanie Promisu, na ktorý treba čakať (await).
%https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function
%async bude v špecifikácii 2017-ky
