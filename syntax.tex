...
Špeciálny typ konštruktora je \emph{factory}. Používa sa rovnako ako obyčajný konštruktor, ale pri volaní konštruktora sa nevytvorí nová inštancia triedy hneď, ale až počas vykonávania tela konštruktora sa rozhodne, aká inštancia bude vytvorená/vrátená. (\emph{Factory} je užitočné napríklad pri implementácii návrhového vzoru Singleton.)
...
Ak chceme, aby program pridal linku na iný objekt (prototype) za nás, môžeme namiesto kľúčového slova \emph{new} použiť funkciu \emph{Object.create(\ldots)}.
